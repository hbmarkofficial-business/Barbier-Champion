  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Bielefeld | Barbier Champion</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Barbier Champion in Bielefeld für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Barbier Champion | Premium Barbershop Bielefeld" />
        <meta
        ...
        <meta name="twitter:title" content="Barbier Champion | Premium Barbershop Bielefeld" />
        <meta
